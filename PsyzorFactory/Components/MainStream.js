...
export default class MainStream extends Component {
  render() {
    ...
    return (
      ...
      <View>
        <Container>
        <Image
          style={{width: 450, height: 200, opacity:0.6}}
          source={{uri: 'https://i.ytimg.com/vi/UJAqEc9N66s/maxresdefault.jpg'}}
        />
<View>
<Label  text="Browse"/>
</View>
...
<Label  text="Popular Categories"/>
        ...
        <Image
          style={{width: 450, height: 200, opacity:0.6}}
          source={{uri: 'https://www.tomorrowland.com/global/img/og.jpg'}}
        />
<View>
<Label  text="Browse"/>
</View>
 ...
 <View>
        ...
        <Image
          style={{width: 450, height: 200, opacity:0.6}}
          source={{uri: 'https://in.bookmyshow.com/entertainment-news/wp-content/uploads/2018/01/Sunburn-Goa-2016.jpg'}}
        />
<View>
<Label  text="Browse"/>
</View>
...
<Label  text="Browse"/>
 ...
 <View style={{flex:1,flexDirection: 'column'}}>
        ...
        <Container>
        <View>
              <Label  text="Videos you may like"/>
    </View>
            <View>
        <Image
          style={{width: 450, height: 200, opacity:0.6}}
